...
export default function Clients() {
  ...
  <div className="m-10 mx-auto  sm:p-20" >
    ...
    <div className="flex items-center pt-5 justify-between">
      <button className="px-2 opacity-50 hover:opacity-100 focus:opacity-100"><img className="w-full img-slider-60" src="https://stripe.com/img/v3/payments/overview/logos/kickstarter.svg" alt="" /></button>
      <button className="px-2 opacity-50 hover:opacity-100 focus:opacity-100"><img className="w-full img-slider-60" src="https://stripe.com/img/v3/payments/overview/logos/slack.svg" alt="" /></button>
      <button className="px-2 opacity-50 hover:opacity-100 focus:opacity-100"><img className="w-full img-slider-60" src="https://stripe.com/img/v3/payments/overview/logos/glossier.svg" alt="" /></button>
      <button className="px-2 opacity-50 hover:opacity-100 focus:opacity-100"><img className="w-full img-slider-60" src="https://stripe.com/img/v3/payments/overview/logos/charity_water.svg" alt="" /></button>
      <button className="px-2 opacity-100 hover:opacity-100 focus:opacity-100"><img className="w-full img-slider-60" src="https://stripe.com/img/v3/payments/overview/logos/missguided.svg" alt="" /></button>
    </div>
