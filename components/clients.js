...
export default function Clients() {
  ...
  <div className="paddings-clientes" >
    ...
    <div className="relative rounded-lg block md:flex items-center bg-gray-100 shadow-xl min-height-19" >
      <div className="relative w-full md:w-2/5 h-full overflow-hidden rounded-t-lg md:rounded-t-none md:rounded-l-lg min-height-19">
        <img className="absolute inset-0 w-full h-full object-cover object-center" src="https://stripe.com/img/v3/payments/overview/photos/missguided.jpg" alt="customer website creation bishkek"/>
      ...
      <div className="w-full md:w-3/5 h-full flex items-center bg-gray-100 rounded-lg">
        <div className="p-12 md:pr-24 md:pl-16 md:py-12">
          ...
          <a  href="#" className="flex items-baseline mt-3 text-indigo-600 hover:text-indigo-900 focus:text-indigo-900" href="">
    ...
    <div className="flex items-center pt-5 justify-between">
      <button className="px-2 opacity-50 hover:opacity-100 focus:opacity-100"><img className="w-full img-slider-60" src="https://stripe.com/img/v3/payments/overview/logos/kickstarter.svg" alt="client creation website bishkek 2" /></button>
      <button className="px-2 opacity-50 hover:opacity-100 focus:opacity-100"><img className="w-full img-slider-60" src="https://stripe.com/img/v3/payments/overview/logos/slack.svg" alt="client creation website bishkek 1 " /></button>
      <button className="px-2 opacity-50 hover:opacity-100 focus:opacity-100"><img className="w-full img-slider-60" src="https://stripe.com/img/v3/payments/overview/logos/glossier.svg" alt="client creation website bishkek 3" /></button>
      <button className="px-2 opacity-50 hover:opacity-100 focus:opacity-100"><img className="w-full img-slider-60" src="https://stripe.com/img/v3/payments/overview/logos/charity_water.svg" alt="client creation website bishkek 4" /></button>
      <button className="px-2 opacity-100 hover:opacity-100 focus:opacity-100"><img className="w-full img-slider-60" src="https://stripe.com/img/v3/payments/overview/logos/missguided.svg" alt="client creation website bishkek 5 " /></button>
    </div>
